...
function GlobalLayout() {
  ...
  return (
    <div className="flex flex-col bg-base-100 text-base-content transition-colors duration-300 ease-in-out">
      <header className="navbar w-screen bg-base-200 text-base-content transition-colors duration-300 ease-in-out p-0">
        <div className="flex-1">
          <a className="btn btn-ghost text-2xl ml-2">Leo Barry</a>
        </div>
          ...
          <ul className="menu menu-horizontal gap-4 p-0">
            ...
            <li>
              <details>
                ...
                <ul className="rounded-t-none gap-2">
                  <li>
                    <a>Link 1</a>
                  </li>
                  <li>
